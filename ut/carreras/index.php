...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="carreras.js"></script>
        <style type="text/css">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-graduation-cap"></i>Nueva Carrera</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Carreras</div>
                            </div>
                        </div>
                    </div>
                </div>
