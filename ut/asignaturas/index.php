<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][4]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="asignaturas.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "asignaturas";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-font"></i>Nueva Asignatura</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Asignaturas</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    <form id="frmAgregar" role="form" class="form-horizontal" action="javascript:agregar();" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                        	...
                        	?>
                            <div class="form-group">
                                <label class="col-md-3 control-label">* IdCuatrimestre::</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="IdCuatrimestreAdd" id="tfIdCuatrimestreAdd">
                                            <option value="">Seleccione una opción</option>
                                            <?php
                        			          $query = $mysqli -> query ("SELECT * FROM CUATRIMESTRES");
                        			          while ($valores = mysqli_fetch_array($query)) {
                        			            echo '<option value="'.$valores[IdCuatrimestre].'">'.$valores[IdCuatrimestre].'  -  '.$valores[Cuatrimestre].'</option>';
                        			          }
                        			        ?>
                                        </select>
                                        <span class="form-control-feedback"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* IdCuatrimestre::</label>
                                        <div class="col-md-8">
                                            <select class="form-control" name="IdCuatrimestreEdit" id="tfIdCuatrimestreEdit">
                                                <option value="">Seleccione una opción</option>
                                                <?php
                            			          $query = $mysqli -> query ("SELECT * FROM CUATRIMESTRES");
                            			          while ($valores = mysqli_fetch_array($query)) {
                            	...
                            	<div class="form-group">
                                    <label class="col-md-3 control-label">* IdCarrera:</label>
                                        <div class="col-md-8">
                                            <select class="form-control" name="IdCarreraEdit" id="tfIdCarreraEdit">
                                                <option value="">Seleccione una opción</option>
                                                <?php
                            			          $query = $mysqli -> query ("SELECT * FROM CARRERAS");
                            			          while ($valores = mysqli_fetch_array($query)) {
