<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Servicios Escolares" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][10]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="titulos.js"></script>

    </head>
    <body onload="cinicial(''); cinicial2(''); cCargos();">
        <div class="page-container">
            <?php
                $pageActive = "consultatitulo";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="active"><a href="#tab-first" role="tab" data-toggle="tab">Títulos</a></li>
                                <li><a href="#tab-second" role="tab" data-toggle="tab">Carreras</a></li>
                                <li><a href="#tab-third" role="tab" data-toggle="tab">Actualizar</a></li>
                                <li><a href="#tab-fourth" role="tab" data-toggle="tab">Importar</a></li>
                            </ul>
                            <div class="panel-body tab-content">
                                <div class="tab-pane active" id="tab-first">
                                    <h3 class="panel-title">Títulos</h3>
                                    <button class="btn btn-default pull-right" onclick="nuevo();"><i class="glyphicon glyphicon-book"></i>Nuevo Título</button>
                                    <br><br><br>
                                    <div id="respuestaTabla">Lista de títulos</div>
                                </div>
                                <div class="tab-pane" id="tab-second">
                                    <h3 class="panel-title">Carreras</h3>
                                    <button class="btn btn-default pull-right" onclick="nuevo2();"><i class="fa fa-location-arrow"></i>Nueva Carrera</button>
                                    <br><br><br>
                                    <div id="respuestaTabla2">Lista de carreras</div>
                                </div>
                                <div class="tab-pane" id="tab-third">
                                    ...
                                    <form id="frmUpdate" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <div class="col-md-8 pull-right">
                                            <input type="file" class="form-control" name="DocUpdate" id="tfDocUpdate" onchange="validarExtUpdate(this);" />
                                            <span class="help-block" style="text-align: justify; color: black;">Solo se aceptan archivos ( .csv ) o ( .CSV ).</span>
                                        </div>
                                    </form>
                                    <br><br><br>
                                    <div id="respuestaTabla3"></div>
                                </div>
                                <div class="tab-pane" id="tab-fourth">
                                    ...
                                    <form id="frmImport" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <div class="col-md-8 pull-right">
                                            <input type="file" class="form-control" name="DocImport" id="tfDocImport" onchange="validarExtImport(this);" />
                                            <span class="help-block" style="text-align: justify; color: black;">Solo se aceptan archivos ( .csv ) o ( .CSV ).</span>
                                        </div>
                                    </form>
                                    <br><br><br>
                                    <div id="respuestaTabla4"></div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label" style="padding-left: 0px;">* Matricula:</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="MatriculaAdd" id="tfMatriculaAdd" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8" id="divCargo"></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Estado:</label>
                                    <div class="col-md-8">
                                        <select name='EstadoAdd' id='cmbEstadoAdd' class='form-control'>
                                            <option value=''>Seleccione el estado del título</option>
                                            <option value='Sin tramite'>Sin tramite</option>
                                            <option value='En tramite'>En tramite</option>
                                            <option value='En la institución'>En la institución</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="ObservacionesAdd" id="txtObservacionesAdd" rows="5" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label" style="padding-left: 0px;">* Matricula:</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="IdEdit" id="tfIdEdit" disabled style="color: #555;" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Nombre:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8" id="divCargoEdit"></div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Estado:</label>
                                    <div class="col-md-8">
                                        <select name='EstadoEdit' id='cmbEstadoEdit' class='form-control'>
                                            <option value='Sin tramite'>Sin tramite</option>
                                            <option value='En tramite'>En tramite</option>
                                            <option value='En la institución'>En la institución</option>
                                            <option value='Entregado'>Entregado</option>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Observaciones:</label>
                                    <div class="col-md-8">
                                        <textarea name="ObservacionesEdit" id="txtObservacionesEdit" rows="5" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
