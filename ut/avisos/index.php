<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][0]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="theme" href="../css/summernote/summernote.css"/>
        ...
        <script type="text/javascript" src="../js/plugins/summernote/lang/summernote-gl-ES.js"></script>

        <script type="text/javascript" src="avisos.js"></script>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    <br>
                    <div class="col-md-12">
                        <div class="panel panel-default" id="pnLista">
                            <div class="panel-heading">
                                <h3 class="panel-title">Avisos</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-bell-o"></i>Nuevo avisos</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de avisos</div>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <span class="help-block">Procure que la imagen no sea ser mayor a 1 Mb, para que cargue más rápido.</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea name="DescripcionAdd" id="txtDescripcionAdd"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom: 0px;">
                                ...
                                <div class="col-md-10">
                                    <div class="alert alert-info" style="background-color: rgba(217, 237, 247, 0.4); color: #29b2e1; display: inline-block;" id="artCamposVacios">
                                       <i class="fa fa-info-circle"></i><strong> Antes de guardar verifique la información ingresada.</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <form id="frmEditar" role="form" class="form-horizontal" action="javascript:modificar();" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="img-file-preview" id="divImgEditPreview">
                                            <div class="img-file-preview-frame">
                                                <img style="width: auto; height: 160px;" id="ImgEditPreview" />
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <textarea name="DescripcionEdit" id="txtDescripcionEdit"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
