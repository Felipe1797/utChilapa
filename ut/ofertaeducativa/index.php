...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="OfertaEducativa.js"></script>
        <style type="text/css">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Oferta Educativa</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-pencil"></i>Nuevo</button>
                            </div>
