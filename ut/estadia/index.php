<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][5]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="estadia.js"></script>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Requisitos para estadia</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-files-o"></i>Nuevo requisitos para estadia</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de requisitos para estadia</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="NivelAdd" id="slcNivelAdd">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Tipo de formato:</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="TipoFormatoAdd" id="slcTipoFormatoAdd">
                                            <option value="">Seleccione una opción</option>
                            ...
                            <div class="form-group" id="artAgregadoExitoso" style="margin-bottom: 0px; display: none;">
                                ...
                                <div class="col-md-10">
                                    <div class="alert alert-success">
                                       <i class="fa fa-check-circle"></i><strong> Agregado con exito.</strong>q
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Nivel:</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="NivelEdit" id="slcNivelEdit">
                                            <option value="TSU">TSU</option>
                                            <option value="ING">ING</option>
                                        </select>
                                        <span class="form-control-feedback"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Tipo de formato:</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="TipoFormatoEdit" id="slcTipoFormatoEdit">
                                            <option value="Calendario">Calendario</option>
                                            <option value="Formatos">Formatos</option>
                                            <option value="Encuestas">Encuestas</option>
                                        </select>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title">Vista detallada</h3><span style="text-align: justify;">Para ver documentos de la paqueteria de office debe descargar los primero.</span>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="kv-zoom-body file-zoom-content">
                            ...
                            <iframe id="docDetail" class="kv-preview-data file-zoom-detail" style="width: 100%; height: 100%; min-height: 480px;"></iframe>
                        </div>
                    </div>
                </div>
             </div>
