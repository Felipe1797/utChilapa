...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="requisitostitulacion.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "requisitostitulacion";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Requisitos para titulación</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-file-text-o"></i>Nuevo requisitos para titulacion</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de requisitos para titulación</div>
                            </div>
                        </div>
                    </div>
                </div>
