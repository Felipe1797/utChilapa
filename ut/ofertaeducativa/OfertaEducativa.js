...
function cinicial(Vals) {
	...
	$.ajax({
		url:"controlOfertaEducativa.php",
...
function agregar() {
	...
	$.ajax({
		url:"controlOfertaEducativa.php",
		data:"opcion=agregar&Tipo=" + Tipo + "&Descripcion=" + Descripcion + "&IdCarrera=" + IdCarrera,
		type:"POST"
	}).done(function(resultados) {
		if (resultados != null && resultados != "") {
			if (resultados == "Bien") {
...
function editar(iduni,tipo,descripcion,idcarrera) {
	$("#mdEditar").modal();
...
function modificar() {
	...
	$.ajax({
		url:"controlOfertaEducativa.php",
		data:"opcion=modificar&IdUni=" + IdUni + "&Tipo=" + Tipo + "&Descripcion=" + Descripcion + "&IdCarrera=" + IdCarrera,
		type:"POST"
	}).done(function(resultados) {
		if (resultados != null && resultados != "") {
			if (resultados == "Bien") {
