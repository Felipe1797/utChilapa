<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][10]==1)) {
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="glyphicon glyphicon-th"></i>Nuevo banner</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Banner</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="form-group" style="margin-bottom: 0px;">
                                ...
                                <div class="col-md-10">
                                    <div class="alert alert-info" style="background-color: rgba(217, 237, 247, 0.4); color: #29b2e1; display: inline-block;" id="artCamposVacios">
                                       ...
                                       <br>
                                       <strong>Por favor, la imagen seleccionada sea de 1780 píxeles de Anchura y 787 píxeles de Altura.</strong>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
