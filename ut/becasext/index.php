<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][3]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="becas.js"></script>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-foursquare"></i>Nueva beca</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Becas</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="TipoAdd" id="tfTipoAdd">
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Documento:</label>
                                    <div class="col-md-8">
                                        <div class="img-file-preview" id="divDocEditPreview">
                                            <div class="img-file-preview-frame">
                                                <embed style="width: 100%; height: 160px;" id="DocEditPreview" />
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Tipo:</label>
                                    <div class="col-md-8">
                                        <select class="form-control" name="TipoEdit" id="tfTipoEdit">
                                            <option value="Externa">Externa</option>
                                            <option value="Interna">Interna</option>
                                        </select>
                                        <span class="form-control-feedback"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
