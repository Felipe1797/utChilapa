                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Estadia</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-paper-plane-o"></i>Nuevo</button>
                            </div>
                ...
                <div class="modal-content">
                    <form id="frmAgregar" role="form" class="form-horizontal" action="javascript:agregar();" enctype="multipart/form-data">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Agregar Estadia</h4>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="frmEditar" role="form" class="form-horizontal" action="javascript:modificar();">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Editar Estadia</h4>
                        </div>
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                <div class="form-group">
