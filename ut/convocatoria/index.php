...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="convocatoria.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "convocatoria";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-convo"></i>Convocatoria de Nuevo Ingreso</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Convocatoria de Nuevo Ingreso</div>
                            </div>
                        </div>
                    </div>
                </div>
