...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="seguimientoegresados.js"></script>
        <style type="text/css">
    ...
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "seguimientoaegresados";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Seguimiento a Egresados</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="glyphicon glyphicon-transfer"></i>Nuevo seguimiento a egresado</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Seguimiento a Egresados</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="frmAgregar" role="form" class="form-horizontal" action="javascript:agregar();" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Testimonio:</label>
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="6" name="TestimonioAdd" id="tfTestimonioAdd"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Testimonio:</label>
                                    <div class="col-md-8">
                                        <textarea class="form-control" rows="6" name="TestimonioEdit" id="tfTestimonioEdit"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
