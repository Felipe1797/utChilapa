...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="reglamento.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "reglamentos";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Reglamentos</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-file-text"></i>Nuevo Reglamento</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista del Reglamentos</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    <form id="frmAgregar" role="form" class="form-horizontal" action="javascript:agregar();" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Agregar Reglamento</h4>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="frmEditar" role="form" class="form-horizontal" action="javascript:modificar();" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Editar Reglamento</h4>
                        </div>
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                <div class="form-group">
