<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][8]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="movilidad.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "movilidad";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Movilidad</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-foursquare"></i>Nueva movilidad</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de Movilidad</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select name="MovilidadAdd" id="cmbMovilidadAdd" class="form-control">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="frmEditar" role="form" class="form-horizontal" action="javascript:modificar();" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Editar Movilidad</h4>
                        </div>
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span class="help-block" style="text-align: justify;">La imagen no debe ser mayor a 1 Mb. La imagen solo se actualizará cuando tenga una imagen seleccionada y se eliminará la imagen anterior.</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Tipo:</label>
                                    <div class="col-md-8">
                                        <select name="MovilidadEdit" id="cmbMovilidadEdit" class="form-control">
                                            <option value="Estudiantil">Estudiantil</option>
                                            <option value="Docentes">Docentes</option>
                                        </select>
                                        <span class="form-control-feedback"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                ...
                <div class="modal-content" style="border: 0px;">
                    ...
                    <div class="modal-body" style="background: rgba(254, 162, 35, 0.9);">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <p style="color: #FFF; font-size: 15px;">¿Esta deacuerdo con esta operación?. Esto eliminará también a los documentos adjuntos.</p>
                            </div>
                        </div>
