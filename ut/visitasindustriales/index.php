<?php 
    ...
    if ( $_SESSION['usuario_cargo'] == "Super Usuario" || $_SESSION['usuario_cargo'] == "Administrador" || ($_SESSION['usuario_cargo'] == "Personal" && $_SESSION['usuario_accesos'][6]==1)) {
...
<html lang="es-MX">
    <head>
        ...
        <script type="text/javascript" src="visitasindustriales.js"></script>

    </head>
    <body onload="cinicial('');">
        <div class="page-container">
            <?php
                $pageActive = "visitasindustriales";
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Visitas Industriales</h3>
                                <button class="btn btn-default pull-right" onclick="nuevo();"><i class="fa fa-plane"></i>Nueva visita industrial</button>
                            </div>
                            <div class="panel-body">
                                <br>
                                <div id="respuestaTabla">Lista de visitas industriales</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form id="frmAgregar" role="form" class="form-horizontal" action="javascript:agregar();" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Descripcón</label>
                                    <div class="col-md-8">
                                        <textarea name="DescripcionAdd" id="tfDescripcionAdd" class="form-control" rows="7"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">* Imagen:</label>
                                    <div class="col-md-8">
                                        <input type="file" class="form-control" multiple name="ImgAdd" id="tfImgAdd" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body">
                            <div class="panel-body">                                    
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Descripcón</label>
                                    <div class="col-md-8">
                                        <textarea name="DescripcionEdit" id="tfDescripcionEdit" class="form-control" rows="7"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Imagen:</label>
                                    <div class="col-md-8">
                                        ...
                                        <input type="file" class="form-control" multiple name="ImgEdit" id="tfImgEdit" />
                                        <input type="hidden" name="ImgEditName" id="tfImgEditName">
                                        <span class="help-block" style="text-align: justify;">La imagen solo se actualizará cuando tenga una nueva seleccionada y la imagen anterior se eliminará.</span>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-content" style="border: 0px;">
                    ...
                    <div class="modal-body" style="background: rgba(254, 162, 35, 0.9);">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <p style="color: #FFF; font-size: 15px;">¿Esta deacuerdo con esta operación?. Esto eliminará también la imagen adjunta.</p>
                            </div>
                        </div>
